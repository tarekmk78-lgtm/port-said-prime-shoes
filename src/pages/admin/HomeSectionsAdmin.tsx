...
// ✅ تم تعريف النوع هنا بدلاً من استيراده من types لتجنب الأخطاء
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="px-6 py-3 bg-[#B8956E] text-white rounded-lg hover:bg-[#9e7d58] transition-colors font-medium"
        >
          + Add New Section
        </button>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#B8956E] focus:border-transparent"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#B8956E]"
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-10 border border-gray-300 rounded-lg px-2 py-1 cursor-pointer"
              />
            </div>
            ...
            <div className="flex items-center md:col-span-2 mt-2">
              <input
                ...
                className="w-4 h-4 text-[#B8956E] border-gray-300 rounded focus:ring-2 focus:ring-[#B8956E]"
              />
              <label htmlFor="is_active" className="ml-2 text-sm font-medium cursor-pointer">Active (Show on homepage)</label>
            </div>
          </div>
      ...
      <div className="space-y-4">
        ...
        {sections.map((section) => (
          <div key={section.id} className="bg-white rounded-lg shadow p-6 flex flex-col md:flex-row items-start md:items-center gap-4 border border-gray-100">
            {section.image_url ? (
              <img src={section.image_url} alt="" className="w-24 h-24 object-cover rounded-lg flex-shrink-0 bg-gray-100" />
            ) : (
              <div className="w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0 text-gray-400 text-xs">No Image</div>
            )}
            <div className="flex-1">
              <h3 className="font-bold text-lg text-gray-900">
                {section.title_ar} {section.title && `/ ${section.title}`}
              </h3>
              <p className="text-sm text-gray-600 mb-1">Type: <span className="font-medium capitalize">{section.section_type.replace('_', ' ')}</span></p>
        ...
        {sections.length === 0 && (
          <p className="text-center text-gray-500 py-8 bg-white rounded-lg border border-dashed border-gray-300">
            No sections added yet. Click "Add New Section" to get started.
          </p>
        )}
      </div>
    </div>

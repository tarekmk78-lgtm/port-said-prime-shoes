        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            <Link 
              ...
              className="group relative bg-[#222] rounded-xl overflow-hidden border border-white/5 hover:border-[#d48a9f]/30 transition-all duration-300 hover:-translate-y-1"
            >
              {/* Image Area */}
